...
async function getData(req, res){
    ...
    /*Los datos obtenidos de la consulta del select los paso por la función helper para que en el caso de que no haya
    * datos devueltos, me devuelva un array vacío. */
